...
- **1.3.1**: corrige o widget flutuante não sumir de verdade quando o mestre oculta o calendário — antes só a janela e o conteúdo do widget mostravam a mensagem de "cego", mas a miniatura continuava ali; agora ela fecha de fato (e reabre sozinha quando revelada de novo, respeitando se o jogador já tinha escondido ela manualmente antes).
